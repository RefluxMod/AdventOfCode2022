...
foreach (var line in File.ReadAllLines("input.txt"))
    jobs[line[..4]] = long.TryParse(line[6..], out long num) ? (' ', "", "", () => num) : GetJob(line[11], line[6..10], line[13..]); // Antingen så är jobbet ett konstant värde eller så är det ett uträknat värde
...
jobs["humn"] = (' ', "", "", () => null); // Nollställ humn så att hela funktionskedjan kan räknas om. Den innehåller då endast värden som går att räkna fram utifrån konstanterna
